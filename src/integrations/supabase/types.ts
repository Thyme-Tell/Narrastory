  ...
  public: {
    ...
    Functions: {
      add_storybook_member: {
        Args: { _storybook_id: string; _email: string; _role: string }
        Returns: boolean
      }
      can_add_storybook_member: {
        Args: { _storybook_id: string; _profile_id: string; _added_by: string }
        Returns: boolean
      }
      can_modify_storybook_members: {
        Args: { _storybook_id: string }
        Returns: boolean
      }
      ...
      create_storybook_with_owner: {
        Args: { _title: string; _description: string; _profile_id: string }
        Returns: Json
      }
      decrypt_text: {
      ...
      get_storybook_member_role: {
        Args: { _storybook_id: string; _profile_id: string }
        Returns: string
      }
      ...
      update_storybook_member_role: {
        Args: { _storybook_id: string; _profile_id: string; _new_role: string }
        Returns: boolean
      }
    }
    Enums: {
