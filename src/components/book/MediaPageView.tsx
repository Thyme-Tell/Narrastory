...
const MediaPageView = ({ 
  ...
  return (
    <div className="w-full h-full overflow-auto p-3 sm:p-6 paper-texture book-page flex flex-col items-center justify-between">
      {/* Header with book title - positioned at the very top, just like TextPageView */}
      <div className="text-center italic text-[#3C2A21] text-xs font-serif pt-4 pb-2 px-6 w-full bg-white/70">
        {bookTitle}
      </div>
      
      <div className="max-w-full max-h-[75%] flex justify-center items-center flex-1 relative px-[15px]">
        <div className="book-content-wrapper w-full h-full flex items-center justify-center">
          {isLoading && (
