  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 flex justify-between items-center pointer-events-none px-1 md:px-2 pb-1">
      <Button 
        ...
        className={`${buttonSize} rounded-full bg-[#00000033] backdrop-blur-sm shadow-md hover:bg-[#00000055] pointer-events-auto ${marginClass} transition-all duration-200 absolute left-1 md:left-2 bottom-0 pb-10`}
      >
      ...
      <Button 
        ...
        className={`${buttonSize} rounded-full bg-[#00000033] backdrop-blur-sm shadow-md hover:bg-[#00000055] pointer-events-auto ${marginClass} transition-all duration-200 absolute right-1 md:right-2 bottom-0 pb-10`}
      >
